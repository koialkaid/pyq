...
export default function AdminMusic() {
  ...
  return <div className="mx-auto max-w-4xl p-4 sm:p-6">
    <div className="mb-6 flex flex-wrap items-center justify-between gap-3"><div><h1 className="text-xl font-bold text-adm-text">R2 音乐歌单</h1><p className="mt-1 text-sm text-adm-text-tertiary">只播放媒体库中已上传到 云端媒体库的音频文件。</p></div><button onClick={() => void saveName()} disabled={saving} className="flex items-center gap-2 rounded-lg bg-adm-primary px-4 py-2 text-sm font-medium text-adm-primary-text disabled:opacity-50"><Save className="h-4 w-4" />保存歌单</button></div>
